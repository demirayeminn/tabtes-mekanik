...
export const metadata: Metadata = {
  title: "Su Tesisatı | Çerkezköy | Tabtes Mekanik",
  description:
    "Çerkezköy'de profesyonel su tesisatı hizmeti. Yeni tesisat, tadilat ve onarım. PPR boru sistemi, kaliteli malzeme, garantili işçilik.",
};
...
const processSteps = [
  {
    ...
    description:
      "Uzman ekibimiz projenizi inceler, ihtiyaçlarınızı belirler ve en uygun çözümü planlar.",
  },
  {
    step: 2,
...
const faqs = [
  ...
  {
    question: "Tesisat yenileme ne kadar sürer?",
    answer:
      "Tesisat yenileme süresi, dairenin büyüklüğüne ve işin kapsamına göre değişir. Ortalama bir daire için 3-5 gün sürmektedir. Keşif sonrası size kesin süre bildirilir.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Tüm tesisat işlerimizde 2 yıl işçilik garantisi veriyoruz. Kullandığımız malzemeler için de üretici garantisi geçerlidir. Garanti kapsamındaki tüm sorunlar ücretsiz çözülür.",
  },
];
    ...
    <main>
      <PageHeader
        ...
        breadcrumbs={[
          ...
          { label: "Su Tesisatı", href: "/hizmetlerimiz/su-tesisati" },
        ]}
      />
            ...
            <div className="lg:col-span-2 space-y-12">
              <div>
                ...
                <div className="text-foreground-muted leading-relaxed space-y-4">
                  <p>
                    Çerkezköy ve çevresinde yeni bina tesisatı, tadilat ve
                    onarım hizmetleri sunuyoruz. Modern PPR boru sistemi veya
                    geleneksel bakır boru seçenekleriyle projelerinizi
                    gerçekleştiriyoruz. 15 yıllık deneyimimizle kaliteli
                    malzeme ve işçilik garantisi veriyoruz.
                  </p>
                  <p>
                  ...
                  <p>
                    Tüm işlemlerimizde TSE standartlarına uygun çalışıyoruz.
                    Kullandığımız malzemeler kalite sertifikalıdır ve uzun
                    ömürlüdür. İşçilik garantimiz 2 yıldır ve bu süre içinde
                    oluşabilecek sorunlar ücretsiz çözülür.
                  </p>
                </div>
              </div>
